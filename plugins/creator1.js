...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
 ...
 let ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, message: `${command} ${type}`, orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
  let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕⸙;;;\nFN:𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕⸙\nORG:𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕⸙\nTITLE:\nitem1.TEL;waid=6283133329293:+62 895-6222-25489\nitem1.X-ABLabel:𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕⸙\nX-WA-BIZ-DESCRIPTION:${htjava} Tᴀᴋ ᴍᴇɴᴇʀɪᴍᴀ sᴀᴠᴇ ᴋᴏɴᴛᴀᴋ!!\nX-WA-BIZ-NAME:𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕⸙\nEND:VCARD`
//------- NOMOR
...
┆⫹⫺ ♂️ Gender : Lanang
┆⫹⫺ 🕋 Agama : Privasi 
┆⫹⫺ ⏰ Tanggal lahir : 16 April 2000
┆⫹⫺ 🎨 Umur : hitung sendiri
┆⫹⫺ 🧮 Kelas : XI
┆⫹⫺ 🧩 Hobby : Banyak
┆⫹⫺ 💬 Sifat : ASIK,BAIK,RAMAH
┆⫹⫺ 🗺️ Tinggal : Ponorogo, Jawa Timur, Indonesia 
┆⫹⫺ ${sigpcr}
└––––––––––––·•
`
  let tek = `⟣⟞⟚⟝ 〨⎣ *Nᴏᴛᴇ* ⎤〨 ⟞⟚⟝⟢
...
{title: "⸙ Biodata 𝐄𝐗𝐂𝐄𝐋𝐋𝐃𝐄𝐕", rowId: ".owner bio"},
